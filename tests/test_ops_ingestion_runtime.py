...
def test_tender_notice_runtime_is_daily_bounded_and_kill_switched() -> None:
    service = TENDER_SERVICE.read_text(encoding="utf-8")
    ...
    assert "RuntimeDirectoryMode=0750" in production_service
