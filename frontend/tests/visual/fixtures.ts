  ...
  if (key === 'GET /dashboard') {
    return {
      body: {
        ...
        plan: {
          code: scenario === 'connected-discovery' ? 'discovery' : 'essential',
          name: scenario === 'connected-discovery' ? 'Découverte' : 'Essential',
          assigned: scenario === 'connected-discovery' ? 3 : null,
          opened_this_month: scenario === 'connected-essential-veteran' ? 1_002 : scenario === 'connected-discovery' ? null : 3,
          quota: scenario === 'connected-discovery' ? 3 : null,
          remaining: scenario === 'connected-discovery' ? 0 : null,
          availability: scenario === 'connected-discovery' ? 'complete' : null,
