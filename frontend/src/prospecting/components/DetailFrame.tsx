...
export function DetailFrame({ title, badge, children, footer, onClose, compact = false }: {
  title: string; badge?: ReactNode; children: ReactNode; footer?: ReactNode; onClose: () => void; compact?: boolean
}) {
  ...
  return <dialog ref={ref} aria-modal="true" aria-labelledby={id} className={compact ? styles.dialog : styles.detail}
