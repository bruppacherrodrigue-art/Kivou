...
export const en: Dictionary = {
  ...
  reference: {
    ...
    overviewPage: {
      ...
      lead:
        'This overview shows up to six awards, summarised from published facts and separated from what still needs checking.',
      reviewFirst: 'Review first',
      publishedAward: 'Published award',
      publishedOn: 'Award published on {source}',
      whyFirst: 'Why it appears first',
      summaryUnavailable:
        'Commercial summary unavailable. Open the signal to review the published facts.',
      analysisUnavailable: 'Analysis unavailable',
      analysisUnavailableBody:
        'No analysis is published: only the contract facts are displayed.',
      factualSummary: 'Factual summary',
      factualSummaryBody:
        'A factual summary is published without commercial interpretation.',
      commercialSummary: 'Commercial summary',
      profileMatchDocumented: 'Documented fit',
      honestyLimit:
    ...
    signalsPage: {
      ...
      presentationUnavailableTitle: 'Commercial analysis unavailable',
      presentationUnavailableBody:
        'Published facts remain available. No summary, relevance reason, need or advice is displayed until a validated presentation has been published.',
      factualFallbackBody:
        'Only a validated factual summary is available. No commercial relevance, priority or action is inferred.',
      presentationDataNotice:
        'This analysis was pre-generated, checked and published by Kivou. Facts, inferences and recommendations remain separate.',
      commercialConclusion: 'Commercial conclusion',
      commercialImportance: 'Why it matters commercially',
      fitReason: 'Why this signal matches your offer',
      timing: 'Timing',
      ...
      linkedEvidence: 'Grounded in published evidence',
      sourceAndFacts: 'Sources and published facts',
      ...
      missingAmount: 'Amount not published',
      missingLocation: 'Territory not published',
      missingExecution: 'Execution period not published',
      missingBuyer: 'Buyer not published',
      missingOfficialTitle: 'Object not provided in the source',
      missingDates: {
        award: 'Award date not published',
        notification: 'Notification date not published',
        publication: 'Publication date not published',
      },
      targetRoleLabels: {
      ...
      roleUnavailable: 'To be identified after qualifying the signal.',
      roleUnavailableDetail:
        'No target role or named contact has been validated at this stage.',
      totalAmountLimit:
    ...
    companiesPage: {
      ...
      listBoundary: 'Each card represents an accessible public award and its named contract holder.',
      ...
      selected: 'Selected',
      recentAward: 'Documented award',
      objectMissing: 'The award object is not provided in the source.',
      buyer: 'Buyer: {buyer}',
