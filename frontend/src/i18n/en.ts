...
export const en: Dictionary = {
  ...
  reference: {
    ...
    companiesPage: {
      publishedHolders: 'Published holders',
      listBoundary: 'A company appears here only when an award notice identifies it as the contract holder.',
      profileSummary: 'Company identified in public notices accessible to your account.',
      provenance: 'Source:',
      documentedContracts: 'Documented contracts',
      contractOne: '{count} contract',
      contractOther: '{count} contracts',
