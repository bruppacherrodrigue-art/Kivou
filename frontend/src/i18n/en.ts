...
export const en: Dictionary = {
  ...
  reference: {
    ...
    companiesPage: {
      ...
      listTitle: 'Detected awards',
      listBoundary: 'Each card represents an accessible public award and its named awarded company.',
      ...
      territory: 'Territory',
      matchKicker: 'Match',
      matchTitle: 'Why it matches your targeting',
      matchMissing: 'No concrete match reason is published for this award.',
      plausibleNeed: 'Plausible need:',
      actionKicker: 'Next step',
      actionTitle: 'Possible commercial action',
      actionFallback: 'Review the full signal and verify the remaining unknowns before making contact.',
      actionUnavailable: 'No commercial action is published for this award.',
      reviewSignal: 'Review the signal analysis',
      ...
      otherAwards: 'Other awards for this company',
      noOtherAwards: 'No other award is accessible for this company.',
      openAward: 'Open award {title}',
      backToAwards: 'Back to awards',
      noSelectionTitle: 'Select an award to view its context',
      noSelectionBody: 'The list keeps its position while the context opens here.',
