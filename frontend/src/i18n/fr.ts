...
export const fr = {
    ...
    reference: {
        ...
        accountSettings: {
            ...
            mainInformation: 'Informations principales',
            profileNotice: 'L’entreprise et l’adresse professionnelle proviennent du compte connecté. Seule la langue peut être modifiée ici.',
            company: 'Entreprise',
            ...
            resetAccess: 'Réinitialiser l’accès',
            securityNotice: 'Le changement passe par un lien sécurisé envoyé par e-mail. Cette page ne conserve et ne modifie aucun mot de passe.',
        ...
        billingSettings: {
            ...
            connectedNotice: 'L’offre, les droits et l’action disponible proviennent de votre compte. Les paiements et résiliations restent gérés dans le portail sécurisé.',
            planLabel: 'Offre',
        ...
        notificationSettings: {
            ...
            connectedNotice: 'L’activation et l’adresse sont enregistrées sur votre compte. La fréquence affichée provient des droits de votre offre.',
        ...
        overviewPage: {
            ...
            lead: 'Cette vue présente jusqu’à six attributions à partir des faits et artefacts réellement publiés.',
            ...
            summaryUnavailable: 'Résumé de l’attribution absent. Ouvrez le signal pour consulter les faits disponibles.',
            analysisUnavailable: 'Présentation absente',
            analysisUnavailableBody: 'Aucune analyse n’est publiée pour cette attribution.',
            factualSummaryBody: 'Un résumé factuel est publié, sans interprétation commerciale.',
            buyerUnavailable: 'Acheteur absent',
            match: 'Correspondance',
            viewAward: 'Voir l’attribution',
            honestyLimit: 'L’avis public documente le marché, sans prouver qu’un achat fournisseur reste ouvert.',
            ...
            noAccessibleSignalBody: 'Les éléments verrouillés restent protégés tant que le backend ne les rend pas accessibles.',
            noAccessibleSignalLimit: 'La page Facturation présente uniquement l’action autorisée pour votre compte.',
            realAccess: 'Accès réel',
            noActiveProfile: 'Aucun profil actif publié.'
        },
        signalsPage: {
            lockedReason: 'Votre accès actuel conserve cet aperçu sans révéler les données protégées.',
    ...
    dashboard: {
        ...
        noOpportunitiesBody: 'Kivou continue de surveiller les publications. Vérifiez vos profils cibles pendant ce temps.',
        noAccessibleCompany: 'Aucune fiche entreprise n’est accessible depuis les signaux actuellement affichées.',
        ...
        contextWithoutUnlocked: 'Aucun signal déverrouillé dans cette analyse ne permet de vérifier une fiche entreprise.',
    ...
    auth: {
        ...
        forgotLead: 'Indiquez votre adresse. Si un compte y est associé, vous recevrez un lien de réinitialisation.',
        forgotSubmit: 'Envoyer le lien',
        forgotConfirmation: 'Si un compte existe pour cette adresse, un lien de réinitialisation vient d’être envoyé.',
        ...
        signupNext: 'Ensuite, indiquez ce que vous vendez et où vous intervenez. Kivou préparera vos premiers signaux.',
        signupNoCard: 'Aucune carte bancaire n’est nécessaire pour découvrir vos premiers signaux.',
    ...
    onboarding: {
        ...
        tradesHelp: 'Facultatif. Sans réponse, Kivou ne restreint pas le type d’entreprise gagnante.',
        ...
        thresholdHelp: 'Les marchés dont le montant n’est pas publié restent visibles, mais passent après ceux dont il l’est.',
        currency: 'Devise',
        minimumAmount: 'Montant minimum',
        ...
        savedNotFinalisedBody: 'Kivou n’a pas pu finaliser l’ouverture de vos signaux. Réessayez : votre profil cible ne sera pas enregistré une seconde fois.',
        finaliseRetry: 'Finaliser et voir mes signaux',
        welcomeTitle: 'Bienvenue dans Kivou',
        welcomeLead: 'Pour recevoir des signaux, Kivou a besoin de savoir ce que vous vendez et où vous intervenez.'
    },
    icp: {
        ...
        limitReached: 'Votre offre {plan} autorise {limit} profil(s) actif(s). Les profils au-delà de cette limite n’alimentent plus votre flux.',
        overLimitBadge: 'Au-delà de la limite de votre offre',
        overLimitHelp: 'Ce profil est conservé mais n’alimente plus votre flux. Passez à une offre supérieure pour le réintégrer au flux.',
        territoryLimitedBadge: 'Limité par votre offre',
        territoryLimitedHelpOne: 'Ce profil conserve ses territoires, mais il n’alimente pas votre flux. Sélectionnez au maximum {limit} territoire pour le réactiver.',
        territoryLimitedHelpOther: 'Ce profil conserve ses territoires, mais il n’alimente pas votre flux. Sélectionnez au maximum {limit} territoires pour le réactiver.',
    ...
    feed: {
        ...
        lead: 'Les entreprises et marchés correspondant à votre profil cible actif, dans l’ordre établi par Kivou.',
        ...
        emptyBody: 'Kivou continue de surveiller les publications. Élargissez la fraîcheur ou ajustez votre profil cible.',
        emptyWiden: 'Voir aussi les signaux plus anciens',
        noIcpTitle: 'Aucun profil cible actif',
        noIcpBody: 'Kivou a besoin de savoir ce que vous vendez et où vous intervenez avant de pouvoir vous montrer des signaux.',
        ...
        truncatedNote: 'La analyse a été bornée : consultez l’Historique pour les signaux plus anciens.',
    ...
    locked: {
        ...
        detailBody: 'Votre accès actuel n’ouvre pas ce signal. L’accès aux signaux dépend des droits de votre offre et de sa fenêtre d’historique.'
    },
    discovery: {
    ...
    evidence: {
        ...
        emptyBody: 'Aucun passage source n’est rattaché à ce signal. Les faits restent ceux publiés par la source, avec une confiance moindre.',
    ...
    feedback: {
        ...
        contactedLead: '« Contacté » signifie seulement que vous avez pris contact. Cela ne dit rien d’une réponse, d’un rendez-vous ou d’une affaire gagnée.',
    ...
    billing: {
        ...
        cancellationAtPeriodEnd: 'Votre abonnement prendra fin à la fin de la période en cours, le {date}.',
        ...
        manageLead: 'Moyen de paiement, factures et résiliation sont gérés dans votre portail de facturation.',
        recoverTitle: 'Accès suspendu — incident de paiement',
        recoverBody: 'Votre abonnement existe toujours, mais l’accès payant est suspendu tant que l’incident de paiement n’est pas régularisé. Votre portail de facturation réunit votre moyen de paiement, vos factures et l’état de votre abonnement.',
        recoverCta: 'Ouvrir le portail de facturation',
        supportTitle: 'Vérification de facturation nécessaire',
        supportBody: 'La facturation de ce compte nécessite une vérification avant toute nouvelle souscription. Écrivez-nous et nous la traiterons.',
        ...
        errors: {
            ...
            checkoutInProgressBody: 'Une session de paiement est déjà ouverte pour ce compte. Terminez-la, ou réessayez après son expiration.',
            checkoutInProgressExpiry: 'Elle expire le {date}.',
            alreadySubscribedTitle: 'Cet abonnement est déjà actif',
            alreadySubscribedBody: 'Ce compte a déjà un abonnement actif. Utilisez la gestion de facturation pour en changer.',
            unavailableTitle: 'Facturation indisponible',
            unavailableBody: 'Le service de paiement n’est pas joignable pour le moment. Réessayez dans quelques instants.',
            noCustomerTitle: 'Aucun dossier de facturation',
            noCustomerBody: 'Ce compte n’a pas encore de dossier de facturation. Il en aura un après un premier paiement.'
        }
    },
    checkout: {
        successTitle: 'Accès payant actif',
        successPending: 'Vérification de votre accès',
        successPendingBody: 'Kivou vérifie l’état de votre abonnement. L’accès ne sera ouvert qu’après confirmation serveur.',
        successBody: 'Votre offre {plan} est active. Vos droits payants sont disponibles.',
        successTimeout: 'Aucun accès payant n’a encore été confirmé. Si vous venez de terminer un paiement, la synchronisation peut prendre quelques minutes.',
        ...
        cancelBody: 'Vous êtes revenu à Kivou depuis le parcours de paiement. Cette page ne modifie pas votre accès. Consultez votre facturation pour vérifier l’état de votre abonnement.',
    ...
    notifications: {
        ...
        cadenceNoneHelp: 'L’offre Découverte n’inclut pas d’alertes e-mail. Consultez votre flux directement.',
    ...
    signalsTable: {
        ...
        drawer: {
            ...
            cpv: 'CPV',
            calendar: 'Calendrier',
            calendarStart: 'Démarrage probable {month}',
            calendarDuration: 'durée {count} mois',
            holderHistory: 'Historique du titulaire',
            marketWonOne: '{count} marché gagné sur 12 mois',
            marketWonOther: '{count} marchés gagnés sur 12 mois',
            recurringBuyers: 'acheteurs récurrents : {buyers}',
            companyProfile: 'Voir la fiche entreprise',
            localCircuit: 'Le circuit local',
            employees: '{count} salariés',
            publicNoticeSource: 'Source : avis public',
            publicAwardsSource: 'Source : marchés publics',
            registerSource: 'Source : registre',
    ...
    errors: {
        ...
        territoryLimitBodyOne: 'Votre offre autorise {limit} territoire par profil. Réduisez votre sélection pour enregistrer ce profil cible.',
        territoryLimitBodyOther: 'Votre offre autorise {limit} territoires par profil. Réduisez votre sélection pour enregistrer ce profil cible.',
        territoryLimitBodyFallback: 'Votre sélection dépasse la limite territoriale de votre offre. Réduisez-la pour enregistrer ce profil cible.',
        filterNotEntitled: 'Ce filtre demande une offre supérieure. Votre flux reste affiché sans ce filtre.',
