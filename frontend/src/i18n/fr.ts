...
export const fr = {
  ...
  reference: {
    ...
    signalsPage: {
      ...
      presentationUnavailableTitle: 'Analyse commerciale indisponible',
      ...
      presentationDataNotice:
        'Cette analyse a été pré-générée, contrôlée puis publiée par Kivou. Les faits, inférences et recommandations restent séparés.',
      commercialConclusion: 'Conclusion commerciale',
      commercialImportance: 'Pourquoi c’est commercialement important',
      fitReason: 'Pourquoi ce signal correspond à votre offre',
      timing: 'Timing',
      ...
      sourceAndFacts: 'Sources et faits publiés',
      ...
      missingAmount: 'Montant non publié',
      missingLocation: 'Territoire non publié',
      missingExecution: 'Période d’exécution non publiée',
      missingBuyer: 'Acheteur non publié',
      missingOfficialTitle: 'Objet non renseigné dans la source',
      missingDates: {
        award: 'Date d’attribution non publiée',
        notification: 'Date de notification non publiée',
        publication: 'Date de publication non publiée',
      },
      targetRoleLabels: {
    ...
    companiesPage: {
      ...
      listBoundary: 'Chaque carte correspond à une attribution publique accessible et à son entreprise titulaire.',
      ...
      recentAward: 'Attribution documentée',
      objectMissing: 'Objet de l’attribution non renseigné dans la source.',
