...
export const fr = {
  ...
  reference: {
    ...
    signalsPage: {
      ...
      dateFrom: 'Du',
      dateTo: 'Au',
      countryFilter: 'Pays (code ISO)',
      subdivisionFilter: 'Zone',
      statusFilter: 'Statut temporel',
      sectorFilter: 'Secteur (préfixe CPV)',
      allStatuses: 'Tous les statuts',
      clearFilters: 'Effacer les filtres',
      restrictedFilter: 'Ce filtre n’est pas inclus dans votre accès actuel.',
      historyGrantsOnly: 'Votre accès Découverte affiche uniquement vos signaux déjà débloqués.',
      historyWindow: 'Votre historique accessible couvre les {days} derniers jours.',
      historyAll: 'Tout l’historique disponible dans Kivou est accessible.',
      endOfList: 'Fin des attributions accessibles.',
      completenessStatus: {
        verified: 'Faits vérifiés',
        pending: 'Enrichissement en attente',
        in_progress: 'Enrichissement en cours',
      ...
      unknownDate: 'Date utile non publiée',
      winnerCompany: 'Entreprise gagnante',
      marketSummary: 'Résumé factuel du marché',
      companyFacts: 'Fiche factuelle de l’entreprise',
      awardsHistory: 'Historique des attributions dans Kivou',
      sourceAndEvidence: 'Source officielle et preuves',
      missingData: 'Données manquantes ou à confirmer',
      verificationDetails: 'Sources et vérification',
      enrichmentPending: 'La fiche entreprise attend son enrichissement factuel.',
      enrichmentInProgress: 'L’enrichissement factuel de l’entreprise est en cours.',
      enrichmentFailed: 'L’enrichissement factuel n’a pas abouti. Les faits du marché restent disponibles.',
      companyLoading: 'Chargement de la fiche factuelle de l’entreprise…',
      companyUnavailable: 'La fiche factuelle complète de l’entreprise n’est pas encore disponible.',
      noOtherAwards: 'Aucune autre attribution accessible n’est enregistrée pour cette entreprise.',
      address: 'Adresse publiée',
      website: 'Site officiel',
      lastVerified: 'Dernière vérification',
      retrievedOn: 'Source récupérée le {date}',
      evidenceFor: 'Preuves pour : {fact}',
      noMissingData: 'Aucune donnée essentielle manquante n’est signalée.',
      missingFieldLabels: {
        market_object: 'Objet du marché',
        amount: 'Montant',
        location: 'Lieu',
        buyer: 'Acheteur',
        event_date: 'Date utile',
        official_identity: 'Identité officielle',
        country: 'Pays',
        address: 'Adresse',
    ...
    companiesPage: {
      ...
      listTitle: 'Attributions détectées',
      listBoundary: 'Chaque carte correspond à une attribution publique accessible et à son entreprise attributaire.',
      profileSummary: 'Entreprise identifiée dans les avis publics accessibles à votre compte.',
      provenance: 'Provenance :',
      documentedContracts: 'Attributions documentées',
      contractOne: '{count} attribution',
      contractOther: '{count} attributions',
      ...
      winningCompany: 'Entreprise attributaire',
      selected: 'Sélectionnée',
      recentAward: 'Attribution récente',
      objectMissing: 'Résumé de l’attribution non publié.',
      buyer: 'Acheteur : {buyer}',
      buyerMissing: 'Acheteur non publié',
      awardedOn: 'Attribuée le {date}',
      notifiedOn: 'Notification du marché le {date}',
      publishedOn: 'Avis publié le {date}',
      eventRecordedOn: 'Date de l’événement : {date}',
      awardDateMissing: 'Date d’attribution non publiée',
      notificationDateMissing: 'Date de notification non publiée',
      publicationDateMissing: 'Date de publication non publiée',
      territoryMissing: 'Territoire non publié',
      awardContext: 'Contexte de l’attribution',
      contextLead: '{company} est l’entreprise attributaire indiquée dans les données publiques accessibles.',
      selectedAward: 'Attribution sélectionnée',
      awardFacts: 'Faits essentiels',
      publicBuyer: 'Acheteur public',
      publishedAmount: 'Montant du marché',
      awardDate: 'Date',
      signalDate: 'Date du signal',
      territory: 'Territoire',
      matchKicker: 'Correspondance',
      matchTitle: 'Pourquoi cela correspond à votre ciblage',
      matchMissing: 'Aucun motif de correspondance concret n’est publié pour cette attribution.',
      plausibleNeed: 'Besoin plausible :',
      actionKicker: 'Prochaine étape',
      actionTitle: 'Action commerciale possible',
      actionFallback: 'Examinez le signal complet et vérifiez les éléments encore inconnus avant tout contact.',
      actionUnavailable: 'Aucune action commerciale n’est publiée pour cette attribution.',
      reviewSignal: 'Voir l’analyse du signal',
      evidenceKicker: 'Traçabilité',
      evidenceTitle: 'Preuves et source officielle',
      sourceMissing: 'Source non publiée',
      sourceUnavailable: 'Le lien vers la source officielle n’est pas publié.',
      openOfficialSource: 'Ouvrir la source officielle',
      otherAwards: 'Autres attributions de cette entreprise',
      noOtherAwards: 'Aucune autre attribution accessible pour cette entreprise.',
      openAward: 'Ouvrir l’attribution {title}',
      backToAwards: 'Retour aux attributions',
      noSelectionTitle: 'Sélectionnez une attribution pour afficher son contexte',
      noSelectionBody: 'La liste conserve votre position pendant que le contexte s’ouvre ici.',
      awardInaccessibleTitle: 'Attribution inaccessible',
      awardInaccessibleBody: 'Cette attribution ne fait pas partie des signaux actuellement accessibles pour cette entreprise.',
    },
    targetingPage: {
  ...
  companiesIndex: {
    title: 'Entreprises attributaires',
    lead: 'Les attributions publiques accessibles dans votre veille, rattachées à leur entreprise titulaire.',
    count: 'Attributions liées',
    open: 'Ouvrir le contexte',
    emptyTitle: 'Aucune attribution accessible pour le moment.',
    emptyBody: 'Les attributions apparaissent ici lorsqu’un signal accessible comporte une entreprise titulaire vérifiable.',
    errorTitle: 'Les attributions n’ont pas pu être chargées.',
    retry: 'Réessayer',
    partial: 'Cette liste reflète les attributions accessibles de votre flux, pas un répertoire exhaustif.',
    partialResultTitle: 'Liste partielle',
    partialResultBody: 'Certaines attributions n’ont pas pu être chargées. Réessayez pour actualiser cette liste.',
  },
