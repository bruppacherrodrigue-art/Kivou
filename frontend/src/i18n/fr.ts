...
export const fr = {
  ...
  reference: {
    ...
    signalsPage: {
      ...
      openNotice: 'Ouvrir l’avis officiel',
      ...
      marketSummary: 'Ce que les données officielles indiquent',
      signalContext: 'Contexte commercial du signal',
    ...
    companiesPage: {
      ...
      listTitle: 'Entreprises détectées',
      listBoundary: 'Chaque carte correspond à une entreprise attributaire et regroupe ses attributions accessibles.',
      ...
      otherAwards: 'Attributions de cette entreprise',
      noOtherAwards: 'Aucune attribution accessible pour cette entreprise.',
      openAward: 'Ouvrir le signal complet pour {title}',
      backToAwards: 'Retour aux entreprises',
      noSelectionTitle: 'Sélectionnez une entreprise pour afficher sa fiche',
      noSelectionBody: 'Ses attributions resteront disponibles comme contexte secondaire.',
  ...
  signalsTable: {
    ...
    drawer: {
      ...
      loading: 'Chargement du signal',
      error: 'Le signal n’a pas pu être chargé.',
    },
