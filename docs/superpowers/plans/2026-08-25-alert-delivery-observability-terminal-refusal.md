...
- [ ] **Step 1: Write the failing handler and ASGI wiring tests**
...
- [ ] **Step 3: Implement the minimal logger and event emitter**
...
- [ ] **Step 4: Wire ASGI/CLI and emit reset outcomes**
...
- [ ] **Step 2: Verify RED, implement the narrow branch, and verify GREEN**
...
- [ ] **Step 3: Write failing old-batch safety tests**
...
- [ ] **Step 5: Implement the fingerprint and exact block**
...
- [ ] **Step 6: Make preference PATCH no-ops stable**
...
- [ ] **Step 7: Emit per-signal alert delivery events and verify GREEN**
...
- [ ] **Step 2: Verify RED, implement minimal precedence, and verify GREEN**
...
- [ ] **Step 2: Verify RED, implement the migration, and verify GREEN**
...
- [ ] **Step 1: Document the corrected operational semantics**
...
- [ ] **Step 2: Run targeted regression (expected at least 48 tests)**
...
- [ ] **Step 3: Run static, migration and diff verification**
...
- [ ] **Step 4: Run PII/secret and scope canaries**
...
- [ ] **Step 5: Self-review and commit docs**
