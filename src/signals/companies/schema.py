...
# Shared public research; never contains an account's contacts or quota.
# No directory FK: a request may create the first registry profile.
company_directory_enrichment_job = sa.Table(
    ...
    sa.Index("ix_company_enrichment_due", "status", "retry_after", "queued_at"),
)
