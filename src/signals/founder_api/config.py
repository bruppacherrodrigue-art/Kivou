...
FOUNDER_ALLOWED_USER_ENV = "KIVOU_FOUNDER_ALLOWED_USER"
...
class FounderApiConfig:
    ...
    def __post_init__(self) -> None:
        ...
        user = self.allowed_user.strip().lower()
        ...
        object.__setattr__(self, "allowed_user", user)
    ...
    def from_environment(cls) -> FounderApiConfig:
        ...
        allowed_user = (os.environ.get(FOUNDER_ALLOWED_USER_ENV) or "").strip()
        ...
        missing = [
            ...
            for name, value in (
                ...
                (FOUNDER_ALLOWED_USER_ENV, allowed_user),
